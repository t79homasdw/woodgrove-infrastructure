#-------------------------------------------------
# Certificate Creation - Application Certificate
#-------------------------------------------------

resource "azurerm_key_vault_certificate" "app_signing_cert" {
  name         = var.cert_name3
  ...
  certificate_policy {
    ...
    x509_certificate_properties {
      subject            = local.cert_subject_name3    # e.g. "CN=mydomain.com"
