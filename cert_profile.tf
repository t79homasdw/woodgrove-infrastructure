#-------------------------------------------------
# Certificate Creation - Profile Certificate
#-------------------------------------------------

resource "azurerm_key_vault_certificate" "profile_signing_cert" {
  name         = var.cert_name2
  ...
  certificate_policy {
    ...
    x509_certificate_properties {
      subject            = local.cert_subject_name2    # e.g. "CN=mydomain.com"
